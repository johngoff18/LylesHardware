...
class ImagePostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create image_post" do
    assert_difference('ImagePost.count') do
      post image_posts_url, params: { image_post: { caption: @image_post.caption, link: @image_post.link } }
    end
  ...
  test "should update image_post" do
    patch image_post_url(@image_post), params: { image_post: { caption: @image_post.caption, link: @image_post.link } }
