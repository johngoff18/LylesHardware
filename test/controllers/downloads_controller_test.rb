...
class DownloadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create download" do
    assert_difference('Download.count') do
      post downloads_url, params: { download: { link: @download.link, name: @download.name } }
    end
  ...
  test "should update download" do
    patch download_url(@download), params: { download: { link: @download.link, name: @download.name } }
